# GRUTraceInferencer_numericCE_noSTART.py
...
from GRUModel import GRUModel  # GRUModel → LSTMModel

# ===== 설정 =====
ORIGINAL_TRACE = "../1m_requests_R/trace_10"
CHUNK_FILE = "../processed_chunks_1m_R/w128_s32/trace_10_chunks.pkl"
MODEL_BASE = "trained_gru_lba/20260225/v0/trace_10"  # GRU 모델 경로
...
def run_inference():
    ...
    with torch.no_grad():
        for _ in range(GENERATE_LENGTH):
            ...
            out = model(input_tensor, h=None)  # ������ GRU forward
