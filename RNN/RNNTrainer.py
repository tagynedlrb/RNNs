# RNNTraceTrainer_numericCE_noSTART_FULLSEQ.py
...
from RNNModel import TraceDataset, RNNModel  # RNNModel → LSTMModel로 변경
...
def train_model():
    ...
    base_dir = os.path.join("trained_rnn_lba", today)
