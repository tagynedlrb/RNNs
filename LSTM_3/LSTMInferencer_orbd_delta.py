...
from LSTMModel_orbd_delta import LSTMModel
...
MODEL_BASE = "trained_lstm_orbd_delta/20260308/v5/trace_283"
...
def recover_magnitude(d2, d1, d0):
    return (
        d2 * ORBD_BASE ** 2 +
        d1 * ORBD_BASE +
        d0
...
def decode_delta(sign, d2, d1, d0):
    mag = recover_magnitude(d2, d1, d0)
...
def run_inference():
    ...
    with torch.no_grad():
        ...
        for _ in range(GENERATE_LENGTH):
            ...
            next_token = [pred_sign, pred_o2, pred_o1, pred_o0]

            delta = decode_delta(pred_sign, pred_o2, pred_o1, pred_o0)
