...
ORBD_BASE = 1024
SIGN_VOCAB = 2  # 0:+ , 1:- , 2:START

# ============================================================
# ===== Dataset 정의 (ORBD delta LSTM) ========================
# ============================================================
...
class TraceDataset(Dataset):
    def __init__(self, chunk_path):
        ...
        for chunk in chunks:
            ...
            # START token
            input_seq.append([2, 1024, 1024, 1024])
...
class LSTMModel(nn.Module):
    def __init__(self, hidden_dim):
        ...
        lstm_input_dim = embed_dim * 4  # sign + 3 digits

        # ===== Embedding =====
        self.sign_embed = nn.Embedding(SIGN_VOCAB + 1, embed_dim)
    ...
    def forward(self, x, h=None):
        ...
        embed = torch.cat([e_sign, e_o2, e_o1, e_o0], dim=-1)

        # LSTM forward
        out, h_next = self.lstm(embed, h)
