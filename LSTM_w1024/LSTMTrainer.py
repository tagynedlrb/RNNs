# LSTMTraceTrainer_numericCE_noSTART_FULLSEQ.py
...
from LSTMModel import TraceDataset, LSTMModel  # LSTMModel → LSTMModel로 변경
...
def train_model():
    ...
    base_dir = os.path.join("trained_lstm_lba", today)
